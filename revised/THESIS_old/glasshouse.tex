...
\begin{figure}[h!]
\begin{center}
\includegraphics[width=\linewidth,keepaspectratio=true]{gasexchange.pdf} % figures can be in pdf, png, jpeg or eps format
...
\begin{figure}[h!]
\begin{center}
\includegraphics[width=\linewidth, keepaspectratio=true]{biomass.pdf} % figures can be in pdf, png, jpeg or eps format
...
\begin{figure}[h!]
\begin{center}
\includegraphics[width=\linewidth,keepaspectratio=true]{traits.pdf} % figures can be in pdf, png, jpeg or eps format
