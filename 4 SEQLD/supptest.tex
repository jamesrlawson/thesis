...
Cumulative proportion  & 0.431 & 0.653 & 0.743 & 0.807 & 0.862 \\
\end{tabu}
\end{table}
...
M\_MaxM        & 0.259  & 0.175  & -0.246 & -0.283 & 0.066  \\
\end{tabu}
\end{table}
...
leaf area (cm2)             & 28.61  & 28.05  \\
maximum height (m)          & 19.79  & 13.98  \\
seed mass (mg)              & 365.99 & 2078.8 \\
SLA (cm2/g)                 & 15.3   & 7.42   \\
wood density (g/cm3)        & 0.609  & 0.13   \\
\end{tabu}
\end{table}
...
\hline
\textit{site} & \textit{Total cover\newline (individuals Ha-1)} & \textit{Represented cover\newline (individuals Ha-1)} & \textit{Proportion\newline represented} \\ \hline
