...
\begin{figure}[h!]
\begin{center}
\includegraphics[width=12cm,keepaspectratio=true]{map2.png} % figures can be in pdf, png, jpeg or eps format
...
Seed mass & Combined mass of the seed coat, endosperm and embryo (g). Excludes dispersal structures. & Larger seed mass confers ability to establish in unfavourable conditions \cite{Leishman2000}. Also related to seed buoyancy \cite{Carthey2015}. & Seeds may be an important food source for animals. \\
...
FDis.SES varied substantially across the study area (3.96 standard deviations of the null distribution), and was associated with gradients of hydrology, flow modification, climatic and soil conditions. The soil model explained 0.483 of the variation in FDis.SES; hydrology, flow modification and climatic models did not independently explain further variation (Fig 4a,b). 
